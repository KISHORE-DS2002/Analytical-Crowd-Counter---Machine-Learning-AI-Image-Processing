...
#-----------------------------------------------------------------------------#
	...
	if len(violate) > 18:
		...
		msg=EmailMessage();
		msg['Subject'] = 'Violations alert!'
		msg['From'] = 'CCTV'
		msg['To'] = 'receiver@gmail.com' #replace "receiver@gmail.com" with receiver email id
		data = "Violations alert! | Violation count:" + str(len(violate))
		msg.set_content(data)
		with smtplib.SMTP_SSL('smtp.gmail.com',465) as server:
		    server=smtplib.SMTP_SSL('smtp.gmail.com',465)
		    server.login("sender@gmail.com","password") #replace "sender@gmail.com" with sender email id
		    server.send_message(msg)
		print("Email sent!", str(len(violate)))
		phnum = "phone number" #replace "phone number" with the phone number to which the whatsapp alert is to be sent
		msg = "Violation alert! | Violation count: " + str(len(violate))
